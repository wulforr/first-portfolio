    ...
    render() {
        return (
            <React.Fragment>
                ...
                <div className="contact" id="contact-id" onClick={this.handleContactClick}>CONTACT</div>
                ...
                <div class="social-buttons">
                    ...
                    {/* <a href="https://codemyui.tumblr.com/" className="social-button tumblr"><i className="fa fa-tumblr"></i></a> */}
                    {/* <a href="https://au.pinterest.com/SaijoGeorge/webdesign-ideas-with-code/" className="social-button pinterest"><i className="fa fa-pinterest"></i></a> */}
